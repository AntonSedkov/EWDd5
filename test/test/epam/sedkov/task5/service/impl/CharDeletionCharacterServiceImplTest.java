...
import by.epam.sedkov.task5.service.impl.CharDeletionCharacterServiceImpl;
import org.testng.annotations.BeforeMethod;
import org.testng.annotations.Test;

import static org.testng.Assert.*;

public class CharDeletionCharacterServiceImplTest {

    CharDeletionCharacterServiceImpl service;
    String input;

    @BeforeMethod
    public void setUp() {
        service = new CharDeletionCharacterServiceImpl();
