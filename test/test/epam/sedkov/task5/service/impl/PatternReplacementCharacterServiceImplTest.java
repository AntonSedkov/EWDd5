...
import by.epam.sedkov.task5.service.impl.PatternReplacementCharacterServiceImpl;
...
public class PatternReplacementCharacterServiceImplTest {

    PatternReplacementCharacterServiceImpl service;
    String input;

    @BeforeMethod
    public void setUp() {
        service = new PatternReplacementCharacterServiceImpl();
