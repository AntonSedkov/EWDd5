...
import by.epam.sedkov.task5.service.impl.StringDeletionCharacterServiceImpl;
...
public class StringDeletionCharacterServiceImplTest {

    StringDeletionCharacterServiceImpl service;
    String input;

    @BeforeMethod
    public void setUp() {
        service = new StringDeletionCharacterServiceImpl();
